...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        FXMLLoader menuFXML = new FXMLLoader(getClass().getResource("/View/Menu.fxml"));
        ...
        MenuController menuController = menuFXML.getController();
        CharController charController = selectCharFXML.getController();
        //----------------------//
